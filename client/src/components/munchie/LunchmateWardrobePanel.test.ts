...
describe('Lunchmate wardrobe preview fixtures', () => {
  it('keeps the manifest counts for all four slots', () => {
    expect(LUNCHMATE_ITEMS_BY_SLOT.outfit).toHaveLength(19);
    expect(LUNCHMATE_ITEMS_BY_SLOT.headwear).toHaveLength(21);
    expect(LUNCHMATE_ITEMS_BY_SLOT.eyewear).toHaveLength(10);
    expect(LUNCHMATE_ITEMS_BY_SLOT.bag).toHaveLength(19);
  });
