          ...
          <g key={place.id} filter="url(#mapShadow)">
            ...
            {showMiniCards && (
              <g transform={`translate(${flipCard ? cx - cardW - 14 : cardX}, ${cardY})`}>
                ...
                <text x={14} y={17} textAnchor="middle" fontSize={9} fill={color} fontFamily="system-ui, sans-serif">
                  {i === 0 ? '🍽' : i === 1 ? '☕' : i === 2 ? '🍷' : i === 3 ? '🎂' : '🍸'}
                </text>
                <rect x={28} y={5} width={28} height={10} rx={3} fill={color} opacity={0.15} />
                <text x={30} y={12.5} fontSize={6} fontWeight={700} fill={color} fontFamily="system-ui, sans-serif">
